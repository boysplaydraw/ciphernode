      ...
      if (compareVersions(latest, CURRENT_VERSION) > 0) {
        ...
        Alert.alert(
          ...
          [
            ...
            {
              text: language === "tr" ? "İndir" : "Download",
          ...
          >
            ...
            <ThemedText
              style={[
                ...
                updateStatus === "available" && { color: Colors.dark.success },
                updateStatus === "up-to-date" && { color: Colors.dark.success },
              ]}
            >
              {updateStatus === "checking"
                ? language === "tr"
