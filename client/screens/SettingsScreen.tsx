...
export default function SettingsScreen() {
  ...
  const safeTopOffset =
    Platform.OS === "android"
      ...
      : headerHeight;
  const { identity, setDisplayName, regenerate, refresh } = useIdentity();
  ...
  const handleFullReset = async () => {
    Alert.alert(
      ...
      [
        ...
        {
          text:
            currentLanguage === "tr" ? "Her Şeyi Sıfırla" : "Reset Everything",
          style: "destructive",
          onPress: async () => {
            try {
              await clearAllData();
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                ...
                currentLanguage === "tr"
                  ? "Kimlik başarıyla içe aktarıldı."
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
          ...
          <View style={styles.sectionContent}>
            ...
            <View style={styles.torInfoRow}>
              ...
              <ThemedText style={styles.torInfoText}>
                {isElectron()
                  ? currentLanguage === "tr"
                    ? "Masaüstü uygulamada Tor yalnızca paket içinde Tor desteği varsa otomatik yönetilir. Web'de Tor Browser kullanın."
                    : "On desktop, Tor is managed automatically only when Tor support is packaged. Use Tor Browser on web."
                  : currentLanguage === "tr"
        ...
        <View style={styles.section}>
          <ThemedText
            style={[styles.sectionTitle, { color: Colors.dark.error }]}
          >
